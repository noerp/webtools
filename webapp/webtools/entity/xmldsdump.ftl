...
<#if security.hasPermission("ENTITY_MAINT", session)>
    <a href="<@noerpUrl>xmldsrawdump</@noerpUrl>" class="buttontext" target="_blank">Click Here to Get Data (or save to file)</a>
<#else>
...
<#macro displayButtonBar>
  <div class="button-bar">
    ...
    <a href="<@noerpUrl>xmldsdump?checkAll=true</@noerpUrl>" class="smallSubmit">${uiLabelMap.WebtoolsCheckAll}</a>
    <a href="<@noerpUrl>xmldsdump</@noerpUrl>" class="smallSubmit">${uiLabelMap.WebtoolsUnCheckAll}</a>
  </div>
</#macro>
...
<#if security.hasPermission("ENTITY_MAINT", session)>
  ...
  <form method="post" action="<@noerpUrl>xmldsdump</@noerpUrl>" name="entityExport">
