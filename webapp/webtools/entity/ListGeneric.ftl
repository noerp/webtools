            ...
            <#if resultPartialList?has_content>
                ...
                <#list records as record>
                    <tr<#if alt_row> class="alternate-row"</#if>>
                        <td class="button-col">
                            <a href='<@noerpUrl>ViewGeneric?${record.findString}</@noerpUrl>'>${uiLabelMap.CommonView}</a>
                        <#if hasDeletePermission == 'Y'>
                            <a href='<@noerpUrl>UpdateGeneric?${record.findString}&amp;UPDATE_MODE=DELETE</@noerpUrl>'>${uiLabelMap.CommonDelete}</a>
                        </#if>
                        </td>
                        <#list fieldList as field>
