...
under the License.
--%>
<%@ page import="java.util.*, java.io.*, java.net.*, java.sql.*, org.noerp.base.util.*, org.noerp.entity.*, org.noerp.entity.model.*, org.noerp.entity.datasource.*" %><jsp:useBean id="delegator" type="org.noerp.entity.GenericDelegator" scope="request" /><jsp:useBean id="security" type="org.noerp.security.Security" scope="request" /><%
...
<entitymodel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
        xsi:noNamespaceSchemaLocation="http://noerp.org/dtds/entitymodel.xsd">
  <!-- ========================================================= -->
  <!-- ======================== Defaults ======================= -->
  <!-- ========================================================= -->
    <title><%=title%></title>
