...
under the License.
--%>
<%@ page contentType="text/plain" %><%@ page import="java.util.*, java.io.*, java.net.*, org.noerp.base.config.*, org.noerp.base.util.*, org.noerp.entity.*, org.noerp.entity.config.*, org.noerp.entity.model.*" %><jsp:useBean id="delegator" type="org.noerp.entity.GenericDelegator" scope="request" /><jsp:useBean id="security" type="org.noerp.security.Security" scope="request" /><%
try {
...
<!DOCTYPE entitymodel PUBLIC "-//OFBiz//DTD Entity Model//EN" "http://noerp.org/dtds/entitymodel.dtd">
<!--
Licensed to the Apache Software Foundation (ASF) under one
or more contributor license agreements.  See the NOTICE file
distributed with this work for additional information
