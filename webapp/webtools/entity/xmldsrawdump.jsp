...
under the License.
--%><%@ page import="java.io.*, java.util.*, java.net.*, org.w3c.dom.*, org.noerp.security.*, org.noerp.entity.*, org.noerp.entity.condition.*, org.noerp.entity.util.*, org.noerp.base.util.*, org.noerp.entity.model.*, org.noerp.entity.transaction.*" %><jsp:useBean id="security" type="org.noerp.security.Security" scope="request" /><jsp:useBean id="delegator" type="org.noerp.entity.GenericDelegator" scope="request" /><%
