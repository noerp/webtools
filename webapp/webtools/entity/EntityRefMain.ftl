                ...
                <table width="95%" border="1" cellpadding='2' cellspacing='0'>
                    <tr class='entityheader'>
                        <td colspan="5">
                            ...
                            <div>${entity.title}&nbsp;
                                <#if !forstatic>
                                    <a target='main' href="<@noerpUrl>FindGeneric?entityName=${entity.entityName}&amp;find=true&amp;VIEW_SIZE=50&amp;VIEW_INDEX=0</@noerpUrl>">[${uiLabelMap.WebtoolsViewData}]</a>
                                </#if>
                                <#if !forstatic>
                                    <a target='main' href="<@noerpUrl>ArtifactInfo?name=${entity.entityName}&amp;type=entity</@noerpUrl>">[${uiLabelMap.WebtoolsArtifactInfo}]</a>
                                </#if>
                            </div>
