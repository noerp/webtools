...
-->
    <div>
       <form action="<@noerpUrl>/entitymaint</@noerpUrl>">
            ...
            <td class="button-col">
              <#if entity.viewEntity == 'Y'>
                <#if entity.entityPermissionView == 'Y'>
                  <a href='<@noerpUrl>ViewRelations?entityName=${entity.entityName}</@noerpUrl>'>${uiLabelMap.WebtoolsReln}</a>
                  <a href='<@noerpUrl>FindGeneric?entityName=${entity.entityName}</@noerpUrl>'>${uiLabelMap.WebtoolsFind}</a>
                  <a href='<@noerpUrl>FindGeneric?entityName=${entity.entityName}&amp;find=true&amp;VIEW_SIZE=50&amp;VIEW_INDEX=0</@noerpUrl>'>${uiLabelMap.WebtoolsAll}</a>
                </#if>
              <#else>
                <#if entity.entityPermissionCreate == 'Y'>
                  <a href='<@noerpUrl>ViewGeneric?entityName=${entity.entityName}</@noerpUrl>' title='${uiLabelMap.CommonCreateNew}'>${uiLabelMap.WebtoolsCreate}</a>
                </#if>
                <#if entity.entityPermissionView == 'Y'>
                  <a href='<@noerpUrl>ViewRelations?entityName=${entity.entityName}</@noerpUrl>' title='${uiLabelMap.WebtoolsViewRelations}'>${uiLabelMap.WebtoolsReln}</a>
                  <a href='<@noerpUrl>FindGeneric?entityName=${entity.entityName}</@noerpUrl>' title='${uiLabelMap.WebtoolsFindRecord}'>${uiLabelMap.WebtoolsFind}</a>
                  <a href='<@noerpUrl>FindGeneric?entityName=${entity.entityName}&amp;find=true&amp;VIEW_SIZE=50&amp;VIEW_INDEX=0</@noerpUrl>' title='${uiLabelMap.WebtoolsFindAllRecords}'>${uiLabelMap.WebtoolsAll}</a>
                </#if>
              </#if>
            </td>
            <#if right_col>
