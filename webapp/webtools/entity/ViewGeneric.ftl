...
<div class="screenlet">
  ...
  <div class="screenlet-body">
    ...
    <div class="button-bar">
      <a href='<@noerpUrl>FindGeneric?entityName=${entityName}&amp;find=true&amp;VIEW_SIZE=50&amp;VIEW_INDEX=0</@noerpUrl>' class="buttontext">${uiLabelMap.WebtoolsBackToFindScreen}</a>
      <#if enableEdit = "false">
        <#if hasCreatePermission>
          <a href='<@noerpUrl>ViewGeneric?entityName=${entityName}&amp;enableEdit=true</@noerpUrl>' class="buttontext create">${uiLabelMap.CommonCreateNew}</a>
          <a href="<@noerpUrl>ViewGeneric?${curFindString}&amp;enableEdit=true</@noerpUrl>" class="buttontext">${uiLabelMap.CommonEdit}</a>
        </#if>
        <#if value?has_content>
          <#if hasDeletePermission>
            <a href='<@noerpUrl>UpdateGeneric?UPDATE_MODE=DELETE&amp;${curFindString}</@noerpUrl>' class="buttontext delete">${uiLabelMap.WebtoolsDeleteThisValue}</a>
          </#if>
        </#if>
      </#if>
    </div>
    ...
    <#if enableEdit = "true">
      <#if hasUpdatePermission || hasCreatePermission>
        ...
        <div id="area2" class="screenlet">
          ...
          <form action='<@noerpUrl>UpdateGeneric?entityName=${entityName}</@noerpUrl>' method="post" name="updateForm">
                ...
                <#if newFieldNoPkList?has_content>
                  ...
                  <tr<#if alt_row> class="alternate-row"</#if>>
                    ...
                    <td>
                      ...
                      <a href="<@noerpUrl>ViewGeneric?${curFindString}</@noerpUrl>" class="smallSubmit">${uiLabelMap.CommonCancel}</a>
                    </td>
                  </tr>
                </#if>
              </#if>
          ...
          <div id="area${(relation_index + 2)}" class="topcontainerhidden">
            <div class="screenlet-title-bar">
              <ul>
                ...
                <li><a href="<@noerpUrl>FindGeneric?${relation.encodeRelatedEntityFindString}&amp;find=true</@noerpUrl>">${uiLabelMap.CommonFind}</a></li>
                <#if relation.valueRelated?has_content>
                  <li><a href="<@noerpUrl>ViewGeneric?${relation.encodeRelatedEntityFindString}</@noerpUrl>">${uiLabelMap.CommonView}</a></li>
                </#if>
                <#if hasAllCreate || relCreate>
                  <li><a href="<@noerpUrl>ViewGeneric?${relation.encodeRelatedEntityFindString}&amp;enableEdit=true</@noerpUrl>">${uiLabelMap.CommonCreate}</a></li>
                </#if>
              </ul>
              <br class="clear"/>
            </div>
            ...
            <#else>
              ...
              <#else/>
              <a href="<@noerpUrl>FindGeneric?${relation.encodeRelatedEntityFindString}&amp;find=true</@noerpUrl>" class="buttontext">${uiLabelMap.CommonFind}</a>
              </#if>
            </#if>
          </div>
      </#list>
