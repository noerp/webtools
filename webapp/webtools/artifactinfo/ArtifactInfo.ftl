...
<#if !artifactInfo??>
    ...
    <div>
      <form name="ArtifactInfoByName" method="post" action="<@noerpUrl>ArtifactInfo</@noerpUrl>" class="basic-form">
    ...
    <div>
      <form name="ArtifactInfoByNameAndType" method="post" action="<@noerpUrl>ArtifactInfo</@noerpUrl>" class="basic-form">
...
<#else/>
    ...
    <#if artifactInfo.getType() == "entity">
        <div><a href="<@noerpUrl>FindGeneric?entityName=${artifactInfo.modelEntity.getEntityName()}&amp;find=true&amp;VIEW_SIZE=50&amp;VIEW_INDEX=0</@noerpUrl>">All Entity Data</a></div>
        <h2>Entity Fields</h2>
        <table>
...
<#macro displayServiceEcaArtifactInfo serviceEcaArtifactInfo>
    ...
    <#if serviceEcaArtifactInfo.serviceEcaRule.getEcaActionList()?has_content>
        ...
        <#list serviceEcaArtifactInfo.serviceEcaRule.getEcaActionList() as ecaAction>
            <tr>
                <td><a href="<@noerpUrl>ArtifactInfo?type=${artifactInfo.getType()}&amp;uniqueId=${ecaAction.getServiceName()}</@noerpUrl>">${ecaAction.getServiceName()}</a></td>
...
<a href="<@noerpUrl>ArtifactInfo?type=${type}&amp;uniqueId=${uniqueId?url('ISO-8859-1')}</@noerpUrl>">${displayName}</a>
</#macro>
