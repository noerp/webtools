...
<script language="JavaScript" type="text/javascript">
    function updateAndSaveLabel() {
        document.UpdateLabelForm.action="<@noerpUrl>SaveLabelsToXmlFile</@noerpUrl>";
        document.UpdateLabelForm.submit();
    }
</script>
<div class="screenlet-body">
    <form method="post" action="<@noerpUrl>SaveLabelsToXmlFile</@noerpUrl>" name="UpdateLabelForm">
