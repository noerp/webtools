...
import org.noerp.entity.transaction.*;
...
if (entitySyncId) {
    passedEntityNames = org.noerp.entityext.synchronization.EntitySyncContext.getEntitySyncModelNamesToUse(dispatcher, entitySyncId);
}
