...
import org.noerp.service.ModelPermGroup;
import org.noerp.service.ModelPermission;
...
List getEcaListForService(String selectedService) {
    ecaMap = org.noerp.service.eca.ServiceEcaUtil.getServiceEventMap(selectedService);
        ...
        ecaValue.each { curRule ->
            ...
            if (actionsVal) {
                ...
                actionsVal.each { curAction ->
                    ...
                    if (org.noerp.service.eca.ServiceEcaAction.equals(actionClass)) {
                        actionMap = [:];
