  ...
  <#if showWsdl?? && showWsdl = true>
    <div class="screenlet">
      ...
      <div class="screenlet-body" align="center">
        ...
        <br />
        <a href='<@noerpUrl>${url}?sel_service_name=${selectedServiceMap.serviceName}</@noerpUrl>' class='smallSubmit'>${uiLabelMap.CommonBack}</a>
      </div>
    </div>
  <#else>
    <div class="screenlet">
      <div class="screenlet-title-bar">
        <ul>
          ...
          <li><a href='<@noerpUrl>${url}</@noerpUrl>'>${uiLabelMap.CommonListAll}</a></li>
          <li><a href='<@noerpUrl>/scheduleJob?SERVICE_NAME=${selectedServiceMap.serviceName}</@noerpUrl>'>${uiLabelMap.WebtoolsSchedule}</a></li>
          <li><a href='<@noerpUrl>/setSyncServiceParameters?SERVICE_NAME=${selectedServiceMap.serviceName}&amp;POOL_NAME=pool&amp;_RUN_SYNC_=Y</@noerpUrl>'>${uiLabelMap.PageTitleRunService}</a></li>
        </ul>
        <br class="clear"/>
      </div>
      <div class="screenlet-body">
        <table class="basic-table" cellspacing='0'>
          <tr>
            ...
            <td><a href='<@noerpUrl>${url}?constraint=engine_name@${selectedServiceMap.engineName}</@noerpUrl>'>${selectedServiceMap.engineName}</a></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>${selectedServiceMap.export}<#if selectedServiceMap.exportBool = "true">&nbsp;(<a href='<@noerpUrl>${url}?sel_service_name=${selectedServiceMap.serviceName}&amp;show_wsdl=true</@noerpUrl>'>${uiLabelMap.WebtoolsShowShowWSDL}</a>)</#if></td>
            <td class="label">${uiLabelMap.WebtoolsLocation}</td>
            <td><a href='<@noerpUrl>${url}?constraint=location@${selectedServiceMap.location}</@noerpUrl>'>${selectedServiceMap.location}</a></td>
          </tr>
          <tr>
            <td class="label">${uiLabelMap.WebtoolsDefinitionLocation}</td>
            <td><a href='<@noerpUrl>${url}?constraint=definitionLocation@${selectedServiceMap.definitionLocation}</@noerpUrl>'>${selectedServiceMap.definitionLocation}</a></td>
            <td class="label">${uiLabelMap.WebtoolsDefaultEntityName}</td>
            <td><a href='<@noerpUrl>${url}?constraint=default_entity_name@${selectedServiceMap.defaultEntityName}</@noerpUrl>'>${selectedServiceMap.defaultEntityName}</a></td>
          </tr>
          <tr>
            <td class="label">${uiLabelMap.WebtoolsArtifactInfo}</td>
            <td><a href='<@noerpUrl>ArtifactInfo?name=${selectedServiceMap.serviceName}&amp;type=service</@noerpUrl>'>${uiLabelMap.WebtoolsArtifactInfo}</a></td>
      ...
      <div class="screenlet-body">
        ...
        <#elseif selectedServiceMap.implServices?has_content>
          <#list selectedServiceMap.implServices as implSrv>
            <a href='<@noerpUrl>${url}?sel_service_name=${implSrv.getService()}</@noerpUrl>'>${implSrv.getService()}</a><br />
          </#list>
        </#if>
      </div>
    </div>
              ...
              <#if ecaMap.actions?has_content>
                <td>
                  <#list ecaMap.actions as action>
                    <table class="basic-table" cellspacing='0'>
                      <tr>
                        <td colspan="2"><a href='<@noerpUrl>${url}?sel_service_name=${action.serviceName}</@noerpUrl>'>${action.serviceName?default(uiLabelMap.CommonNA)}</a></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <#if condition.conditionService?has_content>
                            <a href='<@noerpUrl>${url}?sel_service_name=${condition.conditionService}</@noerpUrl>'>${condition.conditionService?default(uiLabelMap.CommonNA)}</a>
                          <#else>
                ...
                <tr>
                  ...
                  <td>
                    <#if modelParam.entityName??>
                      <a href='<@noerpUrl>${url}?constraint=default_entity_name@${modelParam.entityName}</@noerpUrl>'>${modelParam.entityName!}</a>
                    </#if>
                  </td>
    ...
    <div class="screenlet-body">
      <form name="exportServiceEoModelBundle" method="post" action="<@noerpUrl>exportServiceEoModelBundle</@noerpUrl>" class="basic-form">
  ...
  <#if serviceNamesAlphaList?? && serviceNamesAlphaList?has_content>
      <div class="button-bar">
        ...
        <#list serviceNamesAlphaList as alpha>
          <a href='<@noerpUrl>${url}?constraint=alpha@${alpha}</@noerpUrl>'>${alpha}</a>
      ...
      <table class="basic-table hover-bar" cellspacing='0'>
        ...
        <#list servicesList as service>
          <tr<#if alt_row> class="alternate-row"</#if>>
            <td><a href='<@noerpUrl>${url}?sel_service_name=${service.serviceName}</@noerpUrl>'>${service.serviceName}</a></td>
            <td><a href='<@noerpUrl>${url}?constraint=engine_name@${service.engineName?default(uiLabelMap.CommonNA)}</@noerpUrl>'>${service.engineName}</a></td>
            <td><a href='<@noerpUrl>${url}?constraint=default_entity_name@${service.defaultEntityName?default(uiLabelMap.CommonNA)}</@noerpUrl>'>${service.defaultEntityName}</a></td>
            <td>${service.invoke}</td>
            <td><a href='<@noerpUrl>${url}?constraint=location@${service.location?default(uiLabelMap.CommonNA)}</@noerpUrl>'>${service.location}</a></td>
            <td><a href='<@noerpUrl>${url}?constraint=definitionLocation@${service.definitionLocation}</@noerpUrl>'>${service.definitionLocation}</a></td>
          </tr>
...
<#else>
  ...
  <a href='<@noerpUrl>${url}</@noerpUrl>' class="smallSubmit">${uiLabelMap.CommonListAll}</a>
</#if>
